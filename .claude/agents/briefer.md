---
name: briefer
description: Writes a full, human-friendly task brief to ai/memory/tasks/<id>.md from the current task. Use right after a task is planned.
tools: Read, Write, Edit
---

<!-- GENERATED from ai/personas/06-briefer.md by scripts/sync-claude.sh — do not edit here. -->
